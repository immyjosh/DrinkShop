...
public class Common {
    ...
    public static final String BASE_URL = "http://10.0.2.2/DrinkShoplocal/";
    public static final String API_TOKEN_URL = "http://10.0.2.2/DrinkShoplocal/braintree/main.php";
